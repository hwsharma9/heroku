                ...
                <div class="content-left ">
                    ...
                    <div class="faculty-grid">
                            ...
                            <a href="./s_tanwani.php">
                                <div class="flip-card-inner">
                                    ...
                                    <div class="flip-card-back">
                                        <div class="f-button">View Profile</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="flip-card">
                            <a href="./Ajay_Tiwari.php">
                                <div class="flip-card-inner">
                                    <div class="flip-card-front">
                                        <img src="./images/facultyimg/at.jpg" alt="Avatar" style="">
                                        <div class="front-card-content">
                        ...
                        <div class="flip-card">
                            <a href="./Archana_Chaudhary.php">
                                <div class="flip-card-inner">
                                    <div class="flip-card-front">
                                        <img src="./images/facultyimg/archna.jpg" alt="Avatar" style="">
                                        <div class="front-card-content">
                        ...
                        <div class="flip-card">
                            <a href="./Deepak_Abhyankar.php">
                                <div class="flip-card-inner">
                                    <div class="flip-card-front">
                                        <img src="./images/facultyimg/deepak.jpg" alt="Avatar" style="">
                                        <div class="front-card-content">
                        ...
                        <div class="flip-card">
                            <a href="./Nitin_Uikey.php">
                                <div class="flip-card-inner">
                                    <div class="flip-card-front">
                                        <img src="./images/facultyimg/nu.jpg" alt="Avatar" style="">
                                        <div class="front-card-content">
                        ...
                        <div class="flip-card">
                            <a href="./Hitesh_Ninama.php">
                                <div class="flip-card-inner">
                                    <div class="flip-card-front">
                                        <img src="./images/facultyimg/hitesh.JPG" alt="Avatar" style="">
                                        <div class="front-card-content">
                        ...
                        <div class="faculty-grid">
                            ...
                            <div class="flip-card">
                                <a href="./Priyesh_Kanungo.php">
                                    <div class="flip-card-inner">
                                        <div class="flip-card-front">
                                            <img src="./images/facultyimg/pk.jpg" alt="Avatar" style="">
                                            <div class="front-card-content">
                            ...
                            <div class="flip-card">
                                <a href="./Dr.AlokTiwari.php">
                                    <div class="flip-card-inner">
                                        <div class="flip-card-front">
                                            <img src="./images/facultyimg/temp.png" alt="Avatar" style="">
                                            <div class="front-card-content">
                            ...
                            <div class="flip-card">
                                <a href="./a_more.php">
                                    <div class="flip-card-inner">
                                        <div class="flip-card-front">
                                            <img src="./images/facultyimg/a_more.JPG" alt="Avatar" style="">
                                            <div class="front-card-content">
                                                <h3>Mr. Anand More</h3>
                    ...
                    <!-- <div class="item">
                            <div class="faculty-card">
                                <img loading="lazy" src="./images/facultyimg/" alt="Avatar"
                                    style="width: 100%" />
