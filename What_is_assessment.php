        ...
        <div class="primary-container">
            <div class="main-content-area" id="main-content-area">
                <div class="content-left padding-border">
                    ...
                    <h1>Course Assessment & Accreditation.</h1>
                    <ul>
                        <a href="./Assessment_introduction.php">
                            <li class="content-link">Introduction</li>
                        </a>
                        <a href="./Why_Assessment.php">
                            <li class="content-link">Why Assessment?</li>
                        </a>
                        <a href="./Assessment_Methods.php">
                            <li class="content-link">Assessment Methods</li>
                        </a>
                        <a href="./Improvement_Process.php">
                            <li class="content-link">Improvement Process</li>
                        </a>
                        <a href="./Impact_of_Assessment.php">
                            <li class="content-link">Impact of Assessment</li>
                        </a>
                    </ul>
                </div>
