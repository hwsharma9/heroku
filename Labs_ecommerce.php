        ...
        <div class="primary-container">
            <div class="main-content-area" id="main-content-area">
                <div class="content-left padding-border">
                    ...
                    <section>
                        <h1> Programming System, OS, Internet and E-Commerce Labs</h1>
                        <ul>
                            <li>
                                To provide tools and resources to the software engineer that enable rapid development of
                    ...
                    <section>
                        ...
                        <ul>
                            <li>ERP application in Automobile Industry.</li>
